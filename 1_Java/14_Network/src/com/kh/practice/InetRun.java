...
public class InetRun {
	/*
	 * 네트워크(Network) : 여러대의 컴퓨터들이 연결되어 있는 통신망
	 * 					=> 네트워크를 통해 서로 데이터를 주고받을 수 있음
	 * 
	 * * IP 주소		 : 네트워크 상의 각 컴퓨터들을 식별해주는 번호
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println(iNet);	// "PC 정보(호스트 이름)/IP주소" 출력
			
			System.out.println("내 PC 정보 : "+ iNet.getHostName());		// 내 PC 정보
			System.out.println("내 IP 주소 : "+ iNet.getHostAddress());		// 내 IP 주소
			...
			InetAddress[] iNet3 = InetAddress.getAllByName("www.yahoo.com");
