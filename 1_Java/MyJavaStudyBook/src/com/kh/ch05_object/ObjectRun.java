...
public class ObjectRun {
	...
	public static void main(String[] args) {
		/*
		 * * 객체 : 현실 세계에 독립적으로 존재하는 것들(목적/가치/의미가 잇는 유형/무형/개념 등)
		 * 
		 * * 객체지향 프로그램 : 현실세계의 객체들간의 상호작용을 프로그래밍을 통해
		 * 					가상세계로 구현하는 과정 (프로그래밍)
		 * 	=> 프로그램 상에 필요한 객체들을 만들기 위해 "클래스"라는 틀을 먼저 만들어야함!
		 * 		* 클래스 : 객체들의 속성9정보)들을 담고 있는 틀
		 * 
		 * 		- 추상화 과정 : 대상 객체에 대하여 정리하는 작업
		 * 		[1] 프로그램에서 필요한 대상객체 선정
