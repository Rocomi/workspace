...
public class SetPractice {
	 ...
	 * 		- 데이터 조회 : iterator.참조변수.next()
	 * 
	 *  [2] 향상된 for문(for-each)
	 *  	for(Set에저장된 데이터타입(자료형) 변수명 : Set_참조변수명) {
	 *  		//변수명을 사용하여 데이터에 접근
	 *  	}
	 */
	public static void main(String[] args) {
		/*
		 * Object
		 * 		- equals() 	 : 두 객체의 "주소값"을 비교하여 일치하면 true, 일치하지 않으면 false반환
	...
	//---------------------------------------------------
		...
		hSet1.add("엄희윤님 안녕하세요");
		hSet1.add(new String("엄희윤님 안녕하세요"));
		hSet1.add("여러분");
		hSet1.add("힘들어요;");
		hSet1.add("여러분");
		 ...
		 *  - hashCode() : 재정의. 실제 각 필드에 담긴 데이터들을 합헤서 10진수 반환
		 */
		//---------------------------------------
