		...
		<div class="row">
			...
			<div class="col">
				...
				<div class="input-group">
			  		...
			  		<%
			  		int i1 = (int)request.getAttribute("num1");
			  		int i2 = (int)request.getAttribute("num2");
			  		int minus = 0;
			  		if (i1 >= i2){minus = i1-i2;} 
			  		else {minus = i2-i1;};
			  		%>
					<input type="text" class="form-control focus-ring focus-ring-success" value="<%= minus %>" readonly>
				</div>
