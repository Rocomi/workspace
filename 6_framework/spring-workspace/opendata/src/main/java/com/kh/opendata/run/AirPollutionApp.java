...
public class AirPollutionApp {
	...
	public static void main(String[] args) throws IOException {
		...
		// 서비스 인증 키
		String myKey = "Li3JFTX61TxRm4cXFUjRZPENdqEC0YS3rGqMG8GDfqOhNVhZN5eDtGrmko1cyN12rFJnvwOKzNROJEpGgOIwqQ%3D%3D";
...
//        System.out.println(sb.toString());
        ...
        // JsonObject, JsonArray, JsonElement (gson 라이브러리)
        
        JsonObject jobj = JsonParser.parseString(sb.toString()).getAsJsonObject();
        JsonObject bodyOBJ = jobj.getAsJsonObject("response").getAsJsonObject("body");
